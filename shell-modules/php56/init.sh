...
if [[ -z "$PHP_MODULES" ]]
then
    yum --enablerepo=remi,remi-php56 install -y php php-devel php-opcache php-xcache php-pear php-pecl-xdebug php-pecl-xhprof php-mysql php-pecl-mongo php-redis php-pecl-memcached php-xml php-gd php-mbstring php-mcrypt php-fpm php-gearman php-soap php-curl
else
    yum --enablerepo=remi,remi-php56 install -y php php-devel php-opcache php-xcache php-pear php-pecl-xdebug php-pecl-xhprof php-mysql php-pecl-mongo php-redis php-pecl-memcached php-xml php-gd php-mbstring php-mcrypt php-fpm php-gearman php-soap php-curl $PHP_MODULES
fi
